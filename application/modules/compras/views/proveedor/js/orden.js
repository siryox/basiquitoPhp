...
$(document).on('click',"#add_producto",function(){
   ...
   // $('#add_servicio').attr('disabled',true);
    ...
    nuevaFila=nuevaFila+"<td><input name='subtotal[]' id='subtotal"+idPrd+"' class='form-control form-control-border form-control-sm text-right' readOnly='true'><input type='hidden' name='tsaImpuesto[]' id='tsaImpuesto"+idPrd+"' value='0'/></td>";
