...
abstract class controller
{
        ...
        protected function redireccionar($ruta,$mensaje = false)// metodo que redirecciona la vista
        {
                $modulo=$this->_request->getModulo();
                ...
                if($mensaje)
                {
                        $params = json_encode(["modulo"=>$modulo,"controlador"=>$controlador,"mensaje"=>$mensaje],true);    
                        header("location:".BASE_URL.$ruta.base64_encode($params));
