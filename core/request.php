        ...
        public function __construct()
        {
            ...
            if(isset($_GET['url']))
            {
                ...
                if(defined(APP_MODULE)) 
                {
                        ...
                        $this->_modules = array('seguridad','compras','creditos','reporte','almacen','configuracion','desarrollo','financiamiento','productores','mensajeria',);//contiene los modulos de la aplicacion
